...
class TimeDistributedCNNNet(VQANet):
    ...
    def build(self):
        ...
        image_embedding_lstm_input = RepeatVector(n=self.MAX_QUESTION_LEN)(inputs=image_embedding)
        ...
        image_question_embedding = Concatenate(axis=-1,
                                               name='image_question_embedding')(inputs=[image_embedding_lstm_input, question_embedding])
